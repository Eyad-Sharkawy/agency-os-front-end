...
@Component({
  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="bg-canvas border-hairline relative overflow-hidden rounded-md border p-6 md:p-8">
